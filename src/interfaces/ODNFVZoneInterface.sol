 ...
 */
interface ODNFVZoneInterface is ZoneInterface {
  /**
   ...
   */
  function cancelOrders(SeaportInterface seaport, OrderComponents[] calldata orders) external returns (bool cancelled);
